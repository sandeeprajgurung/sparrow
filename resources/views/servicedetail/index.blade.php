                ...
                <div class="md:flex flex-col md:flex-row md:min-h-screen w-full">
                    ...
                    <div
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <form action="{{ route('servicedetail.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                                ...
                                <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @foreach ($externalServiceDetails as $externalServiceDetail)
                                            <tr>

                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                    {{ $externalServiceDetail->servicename }}
                                                </td>

                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                    {{ $externalServiceDetail->name }}
                                                </td>

                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                    {{ $externalServiceDetail->description }}
                                                </td>

                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                <div class="flex-shrink-0 h-10 w-10">
                                                    @if($externalServiceDetail->image)
                                                        <img class="h-10 w-10 rounded-full" src="{{ asset('storage/' . $externalServiceDetail->image) }}" alt="img">
                                                    @endif
                                                </div>
                                                </td>

                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                    <a href="{{ route('servicedetail.edit', $externalServiceDetail->id) }}" class="text-indigo-600 hover:text-indigo-900 mb-2 mr-2">Edit</a>
                                                    <form class="inline-block" action="{{ route('servicedetail.destroy', $externalServiceDetail->id) }}" method="POST" onsubmit="return confirm('Are you sure?');">
                                                    @csrf
                                                    @method('DELETE')
